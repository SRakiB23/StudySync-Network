      ...
      <footer className="footer p-10 bg-base-300 text-base-content max-w-7xl mx-auto">
        <div>
          ...
          <p className="">
            ...
            with our assignment collection <br /> Join our vibrant community of
            students
          </p>
          <p className="text-gray-500 flex items-center gap-2">
            <FaRegCopyright />
            2024 All rights reserved by StudySync Network.
          </p>
        </div>
        <nav>
          ...
          <a className="link link-hover flex items-center gap-2">
            <FaPhone /> (+88) 01254878454
          </a>
          <a className="link link-hover flex items-center gap-2">
            <HiOutlineMailOpen className="text-xl" /> hello@studysyncnetwork.com
          </a>
        </nav>
        <nav>
          <h6 className="footer-title text-xl">Recent Listing</h6>
          <a className="link link-hover">Covid-19 Assignment</a>
          <a className="link link-hover">Online Eductation</a>
        </nav>
        <nav>
